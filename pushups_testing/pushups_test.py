...
model = load_model("rnn_pushup_posture_model.h5")

with open("rnn_label_encoder_pushup.pkl", "rb") as f:
...
while True:
    ...
    if np.any(keypoints):
        ...
        if posture_label == "correct":
            feedback = "Good! Your pushup form is correct. WWW"
        elif posture_label == "flairing_elbows":
            feedback = "Keep your elbows at 45 degree angle"
        else:
    ...
    cv2.imshow("Pushup Posture Feedback", frame)
